...
First thing to be noted is that the model reach either full employment or full unemployment, unable to stabilize on an intermediate state\footnote{This is a feature of this particular model which has few mechanisms to limit consumption and production. Many SFC models rooted in post-Keynesian theory show a macroscopic state with an intermediate share of employment, particularly those with exogenous government expenditure.}.
This is what in physics is called a phase transition: a rapid macroscopic variation between two states caused by a small microscopic change.
...
Analysing a dynamics like this even in a simple model often requires to untangle a chain of causal relation that can involve many equations and variables with lagged interactions.

The model presented here is developed more as a teaching tool, a way to show basic economic interactions and how to think and implement AB-SFC models.
