...
The most relevant effect of innovation is about the real output. In the previous models, it is stable in the long run while in this version it presents an increasing trend (figure \ref{fig:06ABO_Y}), given by the increase in productivity of the capital goods' stock (figure \ref{fig:06ABO_sb}).
This allows the real consumption to increase as the wealth accumulates.
...
By adding innovation, heterogeneity appears both in households and firms sectors, through wages, productivity, and skills distributions.
Particularly, the capital firms do not compete only on prices, but on the relation between prices and productivity of the sold capital goods; households differentiate themselves for their skill level, or, alternatively, for their "qualification" to work in more productive firms; wages now differentiate among firms and inside each firm, leading to a more fine-grained distribution.
