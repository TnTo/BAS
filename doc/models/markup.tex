...
\begin{figure}
    ...
    \begin{subfigure}[t]{0.49\textwidth}
        ...
        \label{fig:03_p}
    \end{subfigure}
    \caption{Dynamics of the model with dynamic mark-up}
\end{figure}
...
\begin{figure}
    ...
    \begin{subfigure}[t]{0.49\textwidth}
        ...
        \label{fig:03AB_hist}
    \end{subfigure}
    \caption{Dynamics of the AB model with dynamic mark-up}
\end{figure}
...
\begin{figure}
    ...
    \begin{subfigure}[t]{0.49\textwidth}
        ...
        \label{fig:03ABO_p}
    \end{subfigure}
    \caption{Dynamics of the AB model (OOP version) with dynamic mark-up}
\end{figure}