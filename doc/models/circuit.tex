...
This version adds the interest on the loans taken to start the circuit as a cost of production, which is not taken in account in determining the prices.
...
The only relevant difference is a consequence of the heterogeneity of the firms: as a consequence of the random matching, some firms accumulate enough debt to reach negative wealth.
