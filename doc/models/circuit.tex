...
As in the previous versions, firms aim to a null stock of money at the end of each period, so after having "closed the circuit", i.e. repaid the loans with the earnings of the period, they distribute any remaining wealth to households.
...
As in previous iterations, the OOP version is less regular in its behaviour, here creating short term fluctuations in debt dynamics which however smooth out the medium term dynamics (figure \ref{fig:04ABO_L}).
