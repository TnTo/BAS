...
Taxes are paid with a flat rate on wages ($\tau_W$), distributed profits ($\tau_P$) and consumption ($\tau_C$).
...
Given the desired total consumption $Y^T = C^T + G^T$, firms aim to hire a number of workers equal to $N = Y^T/\beta$, where $\beta$ is the productivity in a Leontief function.
...
The distribution of the flows of values among the sector has the right sign and macroscopically realistic magnitudes.
