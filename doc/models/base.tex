...
The flow of funds matrix (\ref{tab:fof}) summurizes the events of the model, with the associated flows of value.
First two rows (Consumption and Government Spending) relates to the goods market: the homogeneus good is sold to both the households and the government.
...
The fourth row (Wages) summirizes the labor market, in which firms employ households and pay them a wage.
...
A first difference is the government spending which is endogenous in our model and exogenous in their one (or like modified version presented in section \ref{sec:base_EC}).
