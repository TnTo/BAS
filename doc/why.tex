...
This approach potentially allows implementing capital goods as objects (see chapter \ref{ch:implementation}) with different productivity levels, "skills" required to be used and wages associated, to enable differentiation in wages levels and firm-worker matches.
