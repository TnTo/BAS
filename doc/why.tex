...
The choice to root the model in the production side of the economy is also a way to recognize, highlight and following this intuition.
...
While it is true that richer individuals are able to achieve higher return rate on their wealth, this mechanism only accelerate the increasing in inequality rather than creating it.
